...
export default function Table({
  ...
  defaultSelectedIds = DEFAULT_EMPTY_ARRAY,
  isRowSelectable = () => true,
  onSelectionChange = DEFAULT_FUNCTION,
  onToggle = DEFAULT_FUNCTION,
  onCancel = DEFAULT_FUNCTION,
  onDelete = DEFAULT_FUNCTION,
  onDetail = DEFAULT_FUNCTION,
  onEdit = DEFAULT_FUNCTION,
  onApprove = DEFAULT_FUNCTION,
  onReject = DEFAULT_FUNCTION,
  onSent = DEFAULT_FUNCTION,
  onUpload = DEFAULT_FUNCTION,
  onFinal = DEFAULT_FUNCTION,
  onPrint = DEFAULT_FUNCTION,
  config = {},
  rowClassName,
}) {
...
Table.propTypes = {
  ...
  defaultSelectedIds: PropTypes.arrayOf(PropTypes.number),
